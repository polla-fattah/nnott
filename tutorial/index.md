...
| Explore MLP architecture & schedule toggles | `python scripts/quickstart_vectorized.py --scenario hidden-sweep --hidden-activations relu,gelu,tanh --dropout 0.2 --batchnorm --lr-schedule cosine --early-stopping` |
